...
public class SimpleCalculatorController extends BaseController {    
    ...
    public void getCalculateAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5412119584860873382L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5489152629935217474L;
            {
                    put( "x", input.getX() );
                    put( "y", input.getY() );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5022197541084917857L;
            {
